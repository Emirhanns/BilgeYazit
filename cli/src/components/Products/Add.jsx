    ...
    >
      <Form layout="vertical" onFinish={onFinish} form={form}>
        ...
        <Form.Item
          name="author"
          label="Yazar Adı"
          rules={[{ required: true, message: "Yazar Adı Alanı Boş Geçilemez!" }]}
        >
        ...
        <Form.Item
          name="stock"
          label="Ürün Adeti"
          rules={[{ required: true, message: "Ürün Adeti Alanı Boş Geçilemez!" }]}
        >
          <Input placeholder="Adet sayısı." type="number" />
        ...
        <Form.Item
          name="shelf"
          label="Raf bilgisi"
          rules={[{ required: true, message: "Raf bilgisi Alanı Boş Geçilemez!" }]}
        >
