...
const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
  ...
  const handlePrint = () => {
    window.print(); // Tüm sayfayı yazdırır, ancak @media print ile sadece seçili alanı göstereceğiz
  };
  ...
  return (
    ...
    >
      {/* Yazdırılacak alan */}
      <div ref={printRef} className="max-w-5xl mx-auto bg-white px-6 printable">
          ...
          <div className="bill-details">
            <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
              <div className="text-md text-slate-500">
                ...
                <p className="text-green-600">{customer?.cName}</p>
                <p> Fake Street 123</p>
                <p> San Javier </p>
                <p> CA 1234</p>
              </div>
      ...
      {/* CSS: Sadece yazdırılacak alanı gösteren stil */}
      <style>{`
        @media print {
          body * {
            visibility: hidden; /* Tüm elemanları gizle */
          }
          .printable, .printable * {
            visibility: visible; /* Yazdırılacak alanı görünür yap */
          }
          .printable {
            position: absolute;
            top: 0;
